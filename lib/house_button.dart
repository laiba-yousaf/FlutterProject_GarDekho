...
class house_button extends StatefulWidget {
  const house_button({super.key});

  @override
  State<house_button> createState() => _house_buttonState();
}

class _house_buttonState extends State<house_button> {
      ...
      body: SingleChildScrollView(
        ...
        children: [
          Stack(children:[
            ...
            Container(child: Image(image: AssetImage(house_buton),)),
            Row(
              children:[
            SizedBox(
              height: 50,
          ...
          Row(
            ...
            children: [
              ...
              //   width: 5,
              // ),
              detail(Image(image: AssetImage(furnish),height: 25,width: 25,), 'N0', 'Furnished'),
            ],
          ),
          Padding(
            padding: const EdgeInsets.only(left: 8, top: 10),
